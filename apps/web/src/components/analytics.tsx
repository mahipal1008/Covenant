...
export function Analytics(): JSX.Element | null {
  ...
  if (posthogKey) {
    // SECURITY (production-readiness-plan.md §H5-web): JSON.stringify the
    // env values so that a malicious quote in PostHog host/key cannot break
    // out of the string literal and inject script into the page.
    return (
